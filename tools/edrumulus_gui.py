...
cmd_val_rng  = [len(pad_types_dict) - 1,       31,     31,          31,         31,          31,     63]
cmd_names   += [             "curve", "rim/pos", "rim boost", "cross", "note", "note rim", "note2"]
cmd_val     += [                 109,       111,         119,     114,    112,        113,     116]
cmd_val_rng += [len(curve_types) - 1,         3,          31,      31,    127,        127,     127]
cmd_names   += ["note2 rim", "rim pos thres", "rim pos sens",         "coupling", "spike (GLOBAL)"]
cmd_val     += [        117,             121,            122,                120,              110]
cmd_val_rng += [        127,              31,             31, len(pad_names) - 1,                4]
...
def store_settings():
  global database
  with settings_file_tmp.open("w") as f:
